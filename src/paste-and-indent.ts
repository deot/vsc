...
export const pasteAndIndent = async () => {
	...
	const leadingSpaces: any[] = []; // The amount of leading space the line has
	let xmin: any; // The minimum amount of leading space amongst the non-empty lines
